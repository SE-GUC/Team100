...
class PR extends Component{
   ...
   //   this.refreshCommittees();
      axios.get("http://localhost:5000/api/committee/5cb1f2f58e6e7c1b48660c9e")
      .then(res=>{
    ...
    //     fetch("http://localhost:9000/api/committee/5cb10a4588e6051e3c73d9a8")
    //       .then(res => res.json())
    //       .then(c => {
    ...
    render(){
        ...
        return(
            ...
            <h1 color="#003255" className="center">PR Committee</h1>
